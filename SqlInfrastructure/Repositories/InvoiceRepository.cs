...
namespace SqlInfrastructure.Repositories {
  public class InvoiceRepository : BaseRepository, IInvoiceRepository {
    ...
    CreateInvoiceAsync(AddInvoiceResource entity,
...
#region Parameters for Invoice Stored Procedure
          ...
          invoiceParams.Add("ConfirmationStatus", entity.ConfirmationStatus,
                            DbType.Boolean);
          invoiceParams.Add("TotalCost", entity.TotalCost, DbType.Decimal);
          invoiceParams.Add("CreatedStaffId", entity.CreatedStaffId,
                            DbType.Int32);
...
#region Parameter for InvoiceProduct Stored Procedure
          ...
          using(var transac = connection.BeginTransaction()) {
            int recordsAffected = await connection.ExecuteAsync(
                sql
                : procedureInvoice, param
                : invoiceParams, commandType
            ...
            try {
              await connection.ExecuteAsync(sql
                                            : procedureInvoiceProduct, param
                                            : invoiceProductParams, commandType
    ...
    /// <returns></returns>
    public Task<int>
    CreateAsync(Invoice entity, CancellationToken cancellationToken = default) {
      ...
      //        #region Parameters for Invoice Stored Procedure
      //        var invoiceParams = new DynamicParameters();
      //        invoiceParams.Add("@Id", 0, DbType.Int32,
      //        ParameterDirection.Output); invoiceParams.Add("CreatedDate",
      //        entity.CreatedDate, DbType.Date);
      //        invoiceParams.Add("ConfirmationStatus",
      //        entity.ConfirmationStatus, DbType.Boolean);
      //        invoiceParams.Add("CreatedStaffId",
      //        entity.CreatedStaff.StaffMemberId, DbType.Int32);
      //        invoiceParams.Add("AgentId", entity.CounterAgent.CounterAgentId,
      //        DbType.Int32); invoiceParams.Add("WarehouseId",
      //        entity.Warehouse.WarehouseId, DbType.Int32);
    ...
    public async Task<int>
    DeleteAsync(int id, CancellationToken cancellationToken = default) {
      try {
    ...
    public async Task<IEnumerable<Invoice>>
      ...
      try {
        ...
        using(var connection = CreateConnection()) {
          ...
          var result = data.GroupBy(p => p.InvoiceId).Select(g => {
            ...
            groupedInvoice.Products =
                g.Select(p => p.Products.Single()).ToList();
    ...
    public Task<int>
    UpdateAsync(Invoice entity, CancellationToken cancellationToken = default) {
      throw new NotImplementedException();
    }

    public async Task<int>
    UpdateInvoiceAsync(int id, AddInvoiceResource entity,
                       CancellationToken cancellationToken = default) {
      try {
        using(var connection = CreateConnection()) {
...
#region Parameter for InvoiceProduct Stored Procedure
    ...
    GetInvoicesWithFilters(InvoiceFilter filter,
                           CancellationToken cancellationToken = default) {
      try {
        using(var connection = CreateConnection()) {
          string query =
...
#region Filtration
          ...
          if ((bool) filter.AgentIsSeller == true &&
              (bool) filter.AgentIsCustomer == true) {
            sqlWhere += " ";
          }
